...
(function() {
	...
	*	Query rate options setter and getter. If an options object is supplied, sets the rate options. If no options are supplied, returns the rate options.
	*
	...
	*/
	Query.prototype.rateOptions = function( options ) {
		var counter, counterMax, resetValue;
		if ( !arguments.length ) {
	...
	*	Tag value setter and getter. If a value is supplied, sets the tag value. If not value is supplied, gets the tag value.
	*
	* @param {String} tag - tag name
	* @param {String} [value] - tag value; e.g., 'foo', 'foo|bar', or '*', where '*' means to request data for all tag values for a given tag name
	* @returns {Client|String} Client instance or tag value
	*/
