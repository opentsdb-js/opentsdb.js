...
(function() {
	...
	*/
	Query.prototype.rateOptions = function( options ) {
		...
		if ( typeof counter !== 'undefined' && typeof counter !== 'boolean' ) {
		...
		if ( typeof counterMax !== 'undefined' && ( typeof counterMax !== 'number' || counterMax !== counterMax ) ) {
		...
		if ( typeof resetValue !== 'undefined' && ( typeof resetValue !== 'number' || resetValue !== resetValue ) ) {
	...
	* @returns {Client|Object|String|undefined} Client instance, all tags, or tag value
	*/
